// WebScribe background service worker: context menu "Add to Notes" for selected text.

const NOTE_PREFIX = "note:";

chrome.runtime.onInstalled.addListener(() => {
  chrome.contextMenus.create({
    id: "WebScribe-add-selection",
    title: "Add to WebScribe",
    contexts: ["selection"]
  });
});

chrome.contextMenus.onClicked.addListener((info, tab) => {
  if (info.menuItemId !== "WebScribe-add-selection") return;
